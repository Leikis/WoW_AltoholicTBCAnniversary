...
function addon:OnEnable()
	...
	-- LEARNED_SPELL_IN_TAB doesn't exist in TBC Anniversary, use SPELLS_CHANGED instead
	pcall(function() addon:RegisterEvent("LEARNED_SPELL_IN_TAB", OnLearnedSpellInTab) end)
	pcall(function() addon:RegisterEvent("SPELLS_CHANGED", OnLearnedSpellInTab) end)
...
function addon:OnDisable()
	...
	pcall(function() addon:UnregisterEvent("LEARNED_SPELL_IN_TAB") end)
	pcall(function() addon:UnregisterEvent("SPELLS_CHANGED") end)
