...
if not GetNumQuestLogRewardSpells then
	GetNumQuestLogRewardSpells = function() return 0 end
end
...
function addon:OnEnable()
	...
	if DataStore.Frames and DataStore.Frames.QuestsOptions and DataStore.Frames.QuestsOptions.DailyResetDropDownLabel then
	...
	local frame = DataStore_Quests_DailyResetDropDown
	if frame then
